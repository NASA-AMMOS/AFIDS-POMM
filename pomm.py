...
class App(Tk):
    def __init__(self):
        ...
        #ttk.utility.enable_high_dpi_awareness(root=self, scaling=2.0)
        ...
        self.pages = {'Splash': Splash, 'Planet': Planet, 'Command': Command,
                      'CoRegister': CoRegister, 'MapProject': MapProject, 'Mosaic': Mosaic}
