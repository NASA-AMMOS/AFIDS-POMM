from tkinter import Frame, Button, CENTER, SE, SW
from components.ComponentRenderer import ComponentRenderer
import ttkbootstrap as ttk
from ttkbootstrap.constants import INFO, OUTLINE, DARK
...
class Mosaic(Frame):
    def __init__(self, parent, *args, **kwargs):
        ...
        label = ttk.Label(self, text="Mosaic", font=('Segoe UI', '16'))
    ...
    def setPage(self, page):
        ...
        ComponentRenderer(self, self.parent, self.innerFrame,
                          self.config['pages'][page]['components'], 'Mosaic')
